...
test_that("Clean Run 3 - Files",{
  ...
  expect_no_error(create_codebook(data=qpack::test1, output="test4-1.xlsx"))
...
test_that("Clean Run 4 - Files with freqs",{
  ...
  test4_3 <- readxl::read_xlsx(file.path(tempdir(), "test4-3.xlsx"),
                               .name_repair = "unique_quiet",
                               sheet=3,)
  expect_equal(names(test4_3), c("...1", "VALUE", "label", "n", "percent"))
...
test_that("Clean Run 5 - Metadata",{
  ...
  expect_equal(test5_1$Description, c("What is your age?",
                                      "What is your gender?",
                                      "How likely are you to recommend Awesome Company to a friend or colleague? - Group",
                                      "How likely are you to recommend Awesome Company to a friend or colleague?"))
